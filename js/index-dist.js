...
/* harmony import */ var _dogstudio_highway__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
...
/* harmony import */ var _transition__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);
...
const H = new _dogstudio_highway__WEBPACK_IMPORTED_MODULE_0___default.a.Core({
    transitions: {
        default: _transition__WEBPACK_IMPORTED_MODULE_1__["default"]
    }
...
class Fade extends _dogstudio_highway__WEBPACK_IMPORTED_MODULE_0___default.a.Transition{
    in({from, to, done}){
        const tl = new gsap__WEBPACK_IMPORTED_MODULE_1__["TimelineLite"]();
        tl.fromTo(to, 0.5, {left:'-100%', top: '50%'}, {left:'0%'})
        .fromTo(to,
            0.5, 
            {height:'2vh'},
            {height: '92vh', top:'8%', onComplete: function(){
                from.remove();
            done();
        }
    }
